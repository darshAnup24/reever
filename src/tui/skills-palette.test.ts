...
describe("selectedSkill", () => {
  it("returns the skill at the current index", () => {
    const skills = [meta("a", "/repo/.reever/skills/a/SKILL.md"), meta("b", "/repo/.reever/skills/b/SKILL.md")];
...
describe("skillScopeLabel", () => {
  it("labels a project-local .reever skill as project", () => {
    expect(skillScopeLabel(meta("a", "/work/repo/.reever/skills/a/SKILL.md"))).toBe("project");
  });
