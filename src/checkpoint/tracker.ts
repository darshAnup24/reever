...
export function checkpointsDir(): string {
  return join(homedir(), ".reever", "checkpoints");
}
 ...
 * startup indexing the entire disk, balloon `~/.reever/checkpoints`, and make
 ...
 * work tree (under `~/.reever/checkpoints/<session>`) and points back at the work
