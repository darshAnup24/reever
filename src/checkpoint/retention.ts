...
/**
 * Shadow-git checkpoint repos under `~/.reever/checkpoints/<session>` are created
 ...
 * old session dirs. This module is reever's equivalent: it `git gc`s the repos worth
