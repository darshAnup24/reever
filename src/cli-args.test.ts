...
describe("parseCliArgs", () => {
  ...
  it("detects --continue and -c", () => {
    expect(parseCliArgs(["--continue"], base).continueLatest).toBe(true);
    expect(parseCliArgs(["-c"], base).continueLatest).toBe(true);
    expect(parseCliArgs([], base).continueLatest).toBe(false);
  });
