...
/** Global MCP config path: `~/.reever/mcp.json`. */
export function mcpConfigPath(): string {
  ...
  return join(home, ".reever", "mcp.json");
}
...
/**
 * Load MCP config: global `~/.reever/mcp.json` merged with optional project
...
/** Persist MCP config to `~/.reever/mcp.json`. */
