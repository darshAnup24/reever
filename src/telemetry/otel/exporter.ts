 ...
 * spans, and tool_start/end become tool spans. Reever sessions map to Langfuse
...
class SpanConsumer implements OtelSpanConsumer {
  ...
  private onTurnStart(turnId: string, firstUserText?: string): void {
    ...
    // scannable; `reever.turn.id` stays the stable identifier. The name is a short
